# -*- coding: utf-8 -*-
"""ann ce model(only 2 way) .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/107pbkh-OEjt1-vI-qxvl0it7cZHFy-7B
"""
...
data = pd.read_csv('/content/Input_data(Pd).csv', header=None)
data=data.iloc[1:]
input_data = data.iloc[:,:17]
output_data = data.iloc[:,23]
